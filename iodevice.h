...
class iodevice {
    ...
    virtual void acceptChar(char data) = 0; //Accepts one byte of data during a Write/Control Operation
    virtual char getChar() = 0; //Retrieves one byte of data during a Read/Sense Operation
